...
type CssVars = React.CSSProperties & Partial<Record<`--${string}`, string | number>>;
...
function SidebarProvider({
	...
	const sidebarWrapperStyle: CssVars = {
...
function Sidebar({
	...
	if (isMobile) {
		const mobileSheetStyle: CssVars = {
